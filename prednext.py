...
#my_scaler = joblib.load('.../feature_scaler.gz')
#my_price_scaler = joblib.load('.../price_scaler.gz')

#loading the lstm model
#new_model_lstm = tf.keras.models.load_model('.../lstm_regmodel_v1.keras')

#loading the gru model
#new_model_gru = tf.keras.models.load_model('.../gru_regmodel_v1.keras')
